...
class AuthService:
    ...
    def login(self, form_data: Any) -> dict:
    ...
    def refresh_token(self, refresh_token: str) -> dict:
        ...
        db_token = self.db.query(tokens.RefreshToken).filter(
        ...
        # Get user
        user = self.db.query(models.User).filter(models.User.user_id == db_token.user_id).first()
        if not user:
