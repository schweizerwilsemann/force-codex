...
import { BookOpen, Search, Calendar, Clock, CheckCircle2, Code2, ArrowRight } from 'lucide-react';
        ...
        <div className={styles.container}>
            <div className={styles.wrapper}>
                ...
                <div className={styles.statsBar}>
                    <button
                        className={`${styles.statBtn} ${filter === 'all' ? styles.active : ''}`}
                    ...
                    <button
                        className={`${styles.statBtn} ${filter === 'pending' ? styles.active : ''}`}
                    ...
                    <button
                        className={`${styles.statBtn} ${filter === 'completed' ? styles.active : ''}`}
                            ...
                            <p>
                                {filter === 'all'
                                    ...
                                    : filter === 'pending'
                                        ...
                                        : 'Hãy bắt đầu làm bài tập đầu tiên!'}
                            </p>
                        </div>
                    ) : (
                                    ...
                                    <div className={styles.cardLeft}>
                                        ...
                                        <div className={styles.cardInfo}>
                                            <div className={styles.cardMeta}>
                                                ...
                                                <span className={`${styles.deadline} ${deadline.class}`}>
                                                    {deadline.text}
                                                </span>
                                            </div>
                                            ...
                                            <div className={styles.problemInfo}>
                                                <Code2 size={14} />
                                                <span>{assignment.problem_title}</span>
                                            </div>
                                            {assignment.due_date && (
