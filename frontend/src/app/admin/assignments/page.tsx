            ...
            <div className={styles.wrapper}>
                <div className={styles.header}>
                    <div className={styles.titleSection}>
                        ...
                        <p>{assignments?.length || 0} phân công</p>
                    </div>
                ...
                <div className={styles.filters}>
                    ...
                    <div className={styles.courseFilter}>
                        <BookOpen size={18} />
                        <select
                            value={searchQuery} // Note: This seemed to filter by text in Lecturer? No, Lecturer used 'selectedCourseFilter'. I need to make sure Admin uses it too? Wait, Admin didn't have a course filter state?
                            // Admin previously filtered by text match on course_name.
                            // I should add a proper Course Filter State to Admin if I want to match Lecturer fully.
                            // For now, I'll stick to text search or simple mapping, but Lecturer has a specific Select.
                            // I will add the state in a following step if missing.
                            onChange={(e) => setSearchQuery(e.target.value)} // Temporary: Re-using search query for now, or just remove this block until state is added?
                        // actually, let's just make it a visual match for now and fix logic in next step.
                        >
